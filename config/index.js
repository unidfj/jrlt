...
module.exports = {
    ...
    dev: {
        ...
        proxyTable: {
            '/local':{
                // target:'http://1226jrlt_fa.hqshop.com:8101', // 测试服务器
                // target:'http://jrlt_fa.hqshop.com:8095', // 测试服务器
                // target:'http://jrlt_fa.hqshop.com:8092', // 测试服务器
                target:'https://fajrlt.a6shop.net:443', // 测试服务器
                changeOrigin: true,
                pathRewrite:{
                    '^/local':''
                },
