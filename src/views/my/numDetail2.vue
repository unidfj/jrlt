<template>
  <div class="page">
    <!-- <m-header :title="lang_text&&(lang!='en'?'当前':lang_text.current)+title+'：'+ (+num).toFixed(2)" :canback="Boolean(1)"> -->
    <m-header :title="lang_text&&(lang!='en'?'当前':' ')+title+'：'+ (+num).toFixed(2)" :canback="Boolean(1)">
